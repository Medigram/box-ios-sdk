...
@interface BoxSelectToPubShareViewController ()

@end

@implementation BoxSelectToPubShareViewController
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    shareController.boxObject = (BoxObject*)[self.rootFolder.children objectAtIndex:indexPath.row];
