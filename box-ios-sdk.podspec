...
Pod::Spec.new do |s|
  s.name         = "box-ios-sdk"
  s.version      = "0.0.1"
  s.summary      = "A short description of mg-ios-rest."
  # s.description  = <<-DESC
  ...
  #                  DESC
  s.homepage     = "http://EXAMPLE/mg-ios-rest"
  ...
  #
  s.source       = { :git => "git@github.com:Medigram/mg-ios-rest.git"}
